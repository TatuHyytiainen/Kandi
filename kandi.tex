...
Teoreemat 2 ja 3 liittyvät parametrien $a$ ja $b$ arvoihin määärääminn rajoihin, joiden mukaan positiivinen tunnistus joko on tai ei ole asymptoottisesti mahdollista. \\
...
Merkitään $\hat{a}$ ja $\hat{b}$ tarkentuvia estimaattoreita parametreille $a$ ja $b$. Estimaattorit $a$ ja $b$ voidaan laskea $\hat{d}$:n ja $\hat{f}$:n avulla siten että 
	...
	\end{align*}
	% 1 \pm \epsilon_{n}^{''''} \in exp{epsilon} 
	% -> k:s juuri -> exp(eps / k) -> ok
